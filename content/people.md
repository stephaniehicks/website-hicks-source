...
| ---------------------------- | ---------------------------- | ---------------------------- |  
| Yongbao Zhuang | ScM student is investigating the development and neurogenesis of the enteric nervous system with single-cell profiling (Joint ScM student with [Subhash Kulkarni](https://www.klab-jhu.com).)
| ---------------------------- | ---------------------------- | ---------------------------- |  
...
| [Erik Nelson](https://cmm.jhmi.edu/index.php/cmm-student/erik-nelson/) | PhD student using spatial transcriptomics and RNA-sequencing data to understand human psychiatric disorders (Joint PhD student with [Keri Martinowich](https://twitter.com/martinowk).) | <img width="200" src="/./images/erik_nelson.png"> |
| ---------------------------- | ---------------------------- | ---------------------------- |  
