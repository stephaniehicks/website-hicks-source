...
Methodology and R software package that implements a generalization of quantile normalization, referred to as smooth quantile normalization (\textbf{qsmooth}), which is based on the assumption that the statistical distribution of each sample should be the same (or have the same distributional shape) within biological groups or conditions [\href{https://github.com/stephaniehicks/qsmooth}{Available on GitHub}]. 
\item
...
Methodology and R software package that can be used to test for differences between groups of distributions to guide the choice if quantile normalization should be used [\href{http://www.bioconductor.org/packages/release/bioc/html/quantro.html}{Available on Bioconductor}]
\item 
