...
\item Review proposals for Chan Zuckerberg Intiative (2019)
...
\mine
Amezquita RA, Lun ATL, Carey VJ, Carpp LN, Geistlinger L, Marini F, Rue-Albrecht K, Risso D, Soneson C, Waldron L, Pages H, Smith M, Huber W, Morgan M, Gottardo R, {\bf Hicks SC}. (2020). Orchestrating Single-Cell Analysis with Bioconductor. Accepted in \dg{{\it Nature Methods}. doi: \url{https://doi.org/10.1101/590562}}.
\mine
 {\bf Hicks SC}, Irizarry RA. (2019). methylCC: technology-independent estimation of cell type composition using differentially methylated regions. Accepted in \dg{{\it Genome Biology}. doi: \url{https://doi.org/10.1101/213769}}.
\mine
...
\item \href{https://normjam.github.io}{NormJam}: A normalization workshop and jamboree for scRNA-seq data. 2019 Nov 19-20. New York City, NY. USA.
\item 
