...
\item PhD., Statistics, Rice University, Houston, TX (2013). \\ 
	\indent {\it Ph.D. Advisors: Marek Kimmel, Ph.D. (Rice) and Sharon Plon, M.D., Ph.D. (Baylor College of Medicine, TX Children's)  } \\
...
\item Assistant Professor, Department of Biostatistics, Johns Hopkins Bloomberg School of Public Health
(2018 -- present).  
\item 
Member, \href{http://jhudatascience.org}{Johns Hopkins Data Science Lab} (2018 -- present).
\item 
Affiliated faculty, \href{https://americanhealth.jhu.edu}{Bloomberg American Health Initiative} (2020 -- 2021). 
...
\item Eastern North American Region (ENAR) (2018 -- present).
\item American Statistical Association (ASA) (2007 -- present).
\item Caucus for Women in Statistics (CWS) (2017 -- 2018).
\item American Mathematical Society (AMS) (2007 -- 2016).
...
\item Member, rOpenSci Statistical Software Standards Board (2020 -- present). 
\item Chair of \href{https://www.amstat.org/committees/commdetails.cfm}{ASA Committee on Women in Statistics} (2020).
\item Member, \href{https://bioconductor.org/about/technical-advisory-board/}{Bioconductor Technical Advisory Board} (2019 -- present).
\item Vice Chair of \href{https://www.amstat.org/committees/commdetails.cfm}{ASA Committee on Women in Statistics} (2019).
\item Co-founder and organizer of \href{https://rladies-baltimore.github.io}{R-Ladies Baltimore}: An organization to promote gender diversity in the R community (2018 -- present).
\item Member, Emerging Technologies Subcommittee of the Bioconductor Technical Advisory Board (2018 -- present).
\item Member of \href{https://www.amstat.org/committees/commdetails.cfm}{ASA Committee on Women in Statistics} (2017 -- 2022).
...
\subsubsection*{Program committee member}

\mydot{-0.1em}

\item Program Committee Member of the \href{https://academicdatascience.org/adsa-meetings/annual-meeting}{Academic Data Science Alliance (ADSA) Annual Meeting}. (2019-2020).
\item Program Committee Member of the \href{https://datascience.columbia.edu/files/seasdepts/idse/pdf-files/FODS2020-CFP.pdf}{Association for Computing Machinery (ACM) and the Institute of Mathematical Statistics (IMS) Foundations of Data Science Conference} (2019-2020). 
\item Program Committee Member of the \href{http://ww2.amstat.org/meetings/sdss/2020/}{2020 Symposium in Data Science and Statistics} (2019 -- 2020).
\item Program Committee Member of the \href{https://ww2.amstat.org/meetings/wsds/2020/}{2020 Women in Statistics and Data Science} (2019 -- 2020).
...
\item Program Committee Member of the \href{https://ww2.amstat.org/meetings/wsds/2019/}{2019 Women in Statistics and Data Science} (2018 -- 2019).
...
\mydot{-0.1em}
\item Session Organizer, Joint Statistical Meetings. (2020). Topic: \textit{Show Me the Data: Making Statistics and Data Science More Diverse and Inclusive in 2020}. 
...
\mydot{-0.1em}
\item Session Chair, Joint Statistical Meetings. (2020). Topic: \textit{Show Me the Data: Making Statistics and Data Science More Diverse and Inclusive in 2020}. 
\item Session Chair, \href{http://www.birs.ca/events/2020/5-day-workshops/20w5197}{Mathematical Frameworks for Integrative Analysis of Emerging Biological Data Types} at Banff International Research Station. Topic: \textit{Computational Challenges Session}. 
...
\item Associate Editor, \href{https://www.bioverlay.org}{\textit{biOverlay}} (2018 -- 2020).
...
\item National Institutes of Health (NIH) Study Section Service for Cellular and Molecular Technologies (CMT) (\href{https://public.era.nih.gov/pubroster/preRosIndex.era?AGENDA=392202&CID=104830}{June 2020}). 
\item Review proposals for \href{https://medium.com/@cziscience/enabling-foundational-tools-for-scientific-discovery-5eb1f5747c35}{Open Source Software for Science} from the Chan Zuckerberg Intiative (May 2020).
\item Review proposals for \href{https://medium.com/@cziscience/the-invisible-foundations-of-biomedicine-4ab7f8d4f5dd}{Open Source Software for Science} from the Chan Zuckerberg Intiative (Oct 2019). 
\item National Science Foundation (NSF) statistical methods panel (Apr 2019).
...
\item Keynote lecture, \href{https://2020.erum.io}{The European R Users Meeting} (2020).
...
\item 
Lahnemann D, Koester J, Szczurek E, McCarthy D, {\bf Hicks S}, Robinson MD, Vallejos C, Beerenwinkel N, Campbell K, Mahfouz A, Pinello L, Skums P, Stamatakis A, Stephan-Otto Attolini C, Aparicio S, Baaijens J, Balvert M, de Barbanson B, Cappuccio A, Corleone G, Dutilh B, Florescu M, Guryev V, Holmer R, Jahn K, Lobo TJ, Keizer E, Khatri I, Kiełbasa S, Korbel J, Kozlov A, Kuo T-H, Lelieveldt B, Mandoiu I, Marioni J, Marschall T, Molder F, Niknejad A, Rączkowski L, Reinders M, de Ridder J, Saliba A-E, Somarakis A, Stegle O, Theis F, Yang H, Zelikovsky A, McHardy A, Raphael B, Shah S, Schonhuth S. (2020). Eleven Grand Challenges in Single-Cell Data Science. \dg{{\it Genome Biology}. {\bf 21}:31 doi: \url{https://doi.org/10.1186/s13059-020-1926-6}}.
\mine
Amezquita RA, Lun ATL, Carey VJ, Carpp LN, Geistlinger L, Marini F, Rue-Albrecht K, Risso D, Soneson C, Waldron L, Pages H, Smith M, Huber W, Morgan M, Gottardo R, {\bf Hicks SC}. (2020). Orchestrating Single-Cell Analysis with Bioconductor. \dg{{\it Nature Methods}. {\bf 17}(2):137-14. PMID: 31792435}.
\item
Townes FW, {\bf Hicks SC}, Ayree MJ Irizarry RA. (2019). Feature Selection and Dimension Reduction for Single Cell RNA-Seq based on a Multinomial Model. \dg{{\it Genome Biology}. {\bf 20}:295. PMID: 31870412. PMCID: PMC6927135}.
\mine
 {\bf Hicks SC}, Irizarry RA. (2019). methylCC: technology-independent estimation of cell type composition using differentially methylated regions. \dg{{\it Genome Biology}. {\bf 20}:261. PMID: 31783894. PMCID: PMC6883691}. 
\mine
Korthauer K, Kimes PK, Duvallet C, Reyes A, Subramanian A, Teng M, Shukla C, Alm EJ, {\bf Hicks SC}. (2019). A Practical Guide to Methods Controlling False Discoveries in Computational Biology. \dg{{\it Genome Biol}. {\bf 20}:118. PMID: 31164141 PMCID: PMC6547503}.
...
\mine {\bf Hicks SC}, Irizarry RA. (2018). A Guide to Teaching Data Science. \dg{{\it The American Statistician} {\bf 72}: 382-391. PMCID: PMC6519964}. 
...
\mine % May 27
{\bf Hicks SC}, Liu R, Ni Y, Purdom E, Risso D (2020). mbkmeans: fast clustering for single cell data using mini-batch $k$-means. . \dg{{\it bioRxiv}. doi: \url{https://doi.org/10.1101/2020.05.27.119438}}.
\item % Feb 28 
Maynard KR, Collado-Torres L, Weber LM, Uytingco C, Barry BK, Williams SR, II JLC,  Tran MN, Besich Z, Tippani M, Chew J, Yin Y, Kleinman JE, Hyde TM, Rao N, {\bf Hicks SC}, Martinowich K, Jaffe AE (2020). Transcriptome-scale spatial gene expression in the human dorsolateral prefrontal cortex. \dg{{\it bioRxiv}. doi:  \url{https://doi.org/10.1101/2020.02.28.969931}}.
\item % Feb 13
Wang Y, {\bf Hicks SC}, Hansen KD. (2020). Co-expression analysis is biased by a mean-correlation relationship. \dg{{\it bioRxiv}. doi: \url{https://www.biorxiv.org/content/10.1101/2020.02.13.944777v1}}.
\mine % Jan 30
Hou W, Ji J, Ji H, {\bf Hicks SC}. (2020). A Systematic Evaluation of Single-cell RNA-sequencing Imputation Methods. \dg{{\it bioRxiv}. doi: \url{https://www.biorxiv.org/content/10.1101/2020.01.29.925974v1}}.
\mine % Jul 25
{\bf Hicks SC}, Peng RD. (2019). Elements and Principles for Characterizing Variation between Data Analyses. \dg{{\it arXiv}. doi: \url{https://arxiv.org/abs/1903.07639}}.
\mine % Apr 29
...
\item
{\bf spQN} $\blacktriangleright$
Methodology and R/Bioconductor package to implement spatial quantile normalization (SpQN). This method was developed to remove a mean-correlation relationship in correlation matrices built from gene expression data and published in \href{https://doi.org/10.1101/2020.02.13.944777}{Wang et al. (2020)}. [\href{http://bioconductor.org/packages/spqn}{Available on Bioconductor}].
\item
...
Methodology and R/Bioconductor software package implementing the mini-batch optimization for $k$-means clustering proposed in \href{https://www.eecs.tufts.edu/~dsculley/papers/fastkmeans.pdf}{Sculley (2010)} for large datasets including single-cell RNA-sequencing data. The mini batch $k$-means algorithm can be run with data stored in memory or on disk (e.g. HDF5 file format). Published in \href{https://doi.org/10.1101/2020.05.27.119438}{Hicks et al. (2020)}. [\href{http://bioconductor.org/packages/mbkmeans}{Available on Bioconductor}]. 
\item 
...
\subsection*{Postdoctoral Fellows\ \tiny * co-mentoring}

\myben{-0.1em}

\item Hou, Wenpin* (2019 -- Present).
\item Weber, Lukas (2019 -- Present).

\ee


\subsection*{Advisees\ \tiny * co-mentoring}

\myben{-0.1em}

\item Kuo, Albert*. Doctor of Philosophy, Biostatistics (2019 -- Present).
\item Dyjack, Nathan. Doctor of Philosophy, Biostatistics (2020 -- Present).
...
\item Dyjack, Nathan. Doctor of Philosophy, Biostatistics (2019 -- Present).
\item Zhang, Jingning. Doctor of Philosophy, Biostatistics (2018 -- 2019).
...
\item \dn{Barry}, Brianna. Biochemistry, Cellular, and Molecular Biology program (BCMB) in the Neuroscience department, Johns Hopkins University School of Medicine. (2020 -- Present). 
...
\item \dn{Zhang}, Boyang. Doctor of Philosophy, Biostatistics (2020). Alternate member. 
\item \dn{Bhattacharya}, Rohit. Doctor of Philosophy, Computer Science (2019). Alternate member. 
\item \dn{Nabi}, Razieh. Doctor of Philosophy, Computer Science (2019).
...
\item \href{https://jhu-advdatasci.github.io/2019/}{140.712 Advanced Data Science II (2019)}.
\item \href{https://jhu-advdatasci.github.io/2019/}{140.711 Advanced Data Science I (2019)}.
...
\item
{\it Cellular Deconvolution of High Grade Serous Ovarian Cancers (Hopkins-Penn Ovarian Cancer SPORE DPR Award).}\\[0.0em]
\dn{Dates:} 06/01/2020 –- 05/31/2021. 
\dn{Principal Investigator:} Casey Greene, PhD.\\
\dn{Responsibility:} Consultant.

\item
{\it Validation of peripheral CGRP signaling as a target for the treatment of pain in chronic pancreatitis (NIH/NIDD R01).}\\[0.0em]
\dn{Dates:} 09/21/2019 –- 08/31/2023. 
\dn{Principal Investigator:} Pankaj Jay Pasricha, MD. \\
\dn{Responsibility:} Co-Investigator.

\item[$\bullet$]
{\it Enabling Analysis and Comprehension of Human Cell Atlas through R / Bioconductor (Chan Zuckerberg Initiative).}\\[0.0em]
\dn{Dates:} 07/01/2019 -- 06/30/2022.
\dn{Principal Investigator:} Stephanie Hicks, PhD.\\
\dn{Responsibility:} Co-PI (MPI).

\item[$\bullet$]
{\it Hands-On Data Science Education for Thousands of Students in Tackling Public Health Challenges (Bloomberg Philanthropies).}\\[0.0em]
\dn{Dates:} 09/01/2019 –- 08/31/2020. 
\dn{Principal Investigator:} Stephanie C. Hicks, PhD.\\
\dn{Responsibility:} Principal Investigator.

\item
{\it Characterization of high-grade serous ovarian cancer subtypes via single-cell profiling (NIH/NCI R01).}\\[0.0em]
\dn{Dates:} 05/01/2019 –- 04/30/2023. 
\dn{Principal Investigator:} Casey Greene, PhD. Jen Doherty, PhD.\\
\dn{Responsibility:} Co-Investigator.

\item[$\bullet$]
{\it Statistical Methods for the Normalization and Quantification of Single-Cell RNA-Sequencing Data (NIH/NHGRI K99/R00).}\\[0.0em]
\dn{Dates:} 12/23/2016 -- 02/28/2021. 
\dn{Principal Investigator:} Stephanie C. Hicks, PhD.\\
\dn{Responsibility:} Principal Investigator.
...
\dn{Principal Investigators:} Sahand Hormoz, PhD. Yuchao Jiang, PhD. Stephanie C. Hicks, PhD.\\
\dn{Responsibility:} Co-PI (MPI).
...
\item Member, Faculty search committee (2019--2020).
...
\myben{0.3em}
\item \href{https://meetings.cshl.edu/meetings.aspx?meet=DATA&year=20}{{\it Biological Data Science}}. 2020 Nov 4-7. Cold Spring Harbor Laboratory, NY. USA. (Virtual due to COVID-19).
\item {\it Communicating statistics and data science to the masses via Open Case Studies}. \\
\href{https://ww2.amstat.org/meetings/jsm/2020/}{{\it Joint Statistical Meetings}}. 2020 Aug 1-6. Philadelphia, PA. USA. (Virtual due to COVID-19).
\item Annual Symposium of the Division of Gastroenterology at Johns Hopkins University. 2020 Jun 23. Baltimore, MD. USA. (Postponed to due COVID-19).
\item {\it \href{https://docs.google.com/presentation/d/1TRmPRv4k4aceJbdVQDub4hCXYvIdTeQfDJZfpBu28PQ/edit?usp=sharing}{Using R and data science to improve human health}}. \\ 
\textbf{Keynote presentation} at \href{https://2020.erum.io}{The European R Users Meeting}. 2020 June 17-20. Milan, Italy. (Virtual). \href{https://youtu.be/8Fy2oKPFeRE}{Watch pre-conference interview on YouTube}.
\item \href{https://www.mailman.columbia.edu/public-health-now/events/seminars-conferences/data-science-public-health-summit}{Data Science for Public Health Summit} at Columbia Mailman School of Public Health. 2020 Jan 17. New York City, NY. USA.
\item 
\href{https://sites.google.com/msdse.org/datascienceleadership2019}{Data Science Leadership Summit}. 2019 Nov 7-9. Santa Fe, NM. USA.
\item 
{\it \href{https://docs.google.com/presentation/d/1emK1ORCmRaJLYDYwWPGhaqNRY2D8cdem_EIFmCmqS00/edit?usp=sharing}{Addressing Public Health Challenges through Data Science Education}}. \\ 
American Public Health Association Annual Meeting. 2019 Nov 2-6. Philadelphia, PA. USA.
\item 
{\it \href{https://docs.google.com/presentation/d/1whqrmbkilpZopqfg8MQ6MRJR2PYUAAsbCxwK-eq-HDM/edit?usp=sharing}{Making data science accessible in the Johns Hopkins Data Science Lab}}. \\
Mathematics Departments and the Explosive Growth of Computational and Quantitative Offerings in Higher Education. \href{http://www.ams.org/meetings/coeminiconference}{AMS Annual Mini-conference on Education} 2019 Oct 25. Washington, D.C. USA 
\item 
{\it \href{https://speakerdeck.com/stephaniehicks/teaching-data-science-through-case-studies-in-public-health}{Teaching data science through case studies in Public Health}}. \\
...
\textbf{Keynote presentation} at \href{https://bioconductor.github.io/BiocAsia/}{Bioconductor Asia} on 2018 Nov 29 at the University of Melbourne, Melbourne, Australia.  \\
\textbf{Keynote presentation} at \href{https://bis.amsi.org.au}{Australian Mathematical Sciences Institute (AMSI) Bioinfosummer} on 2018 Dec 3-7 at the University of Western Australia, Perth, Australia.
\item 
...
DC R Conference. 2018 Nov 8. Washington D.C., USA. \href{https://youtu.be/l1MQ7x8cn7Y}{Watch talk on YouTube}. 
\item 
...
\item 
{\it Panelist on 'Florence Nightingale 200th Anniversary'}. \\
\href{https://ww2.amstat.org/meetings/jsm/2020/}{{\it Joint Statistical Meetings}}. 2020 Aug 1-6. Philadelphia, PA. USA. (Virtual due to COVID-19).
\item 
{\it Bench pressing single-cell RNA-sequencing imputation methods}. \\
\href{http://bioc2020.bioconductor.org}{{\it Bioconductor Conference}}. 2020 Jul 29-31. Boston, MA, USA. (Virtual due to COVID-19).
\item 
{\it Fast clustering for single-cell RNA-seq data using mini-batch k-means}.\\
\href{https://enar.org/meetings/spring2020/}{ENAR Conference}. 2020 Mar 22-25. Nashville, TN. USA. (Virtual due to COVID-19).
\item 
...
\item 
Human Medical Genetics and Genomics Program, University of Colorado (Anschutz Medical Campus). 2020 Apr 15. Denver, CO. USA. (Postponed to due COVID-19).
\item 
Department of Biostatistics and Informatics, Colorado School of Public Health. 2020 Apr 16. Denver, CO. USA. (Postponed to due COVID-19).
\item National Cancer Institute (NCI) / Center for Cancer Research (CCR) Bioinformatics Training and Education Program (BTEP) \href{https://btep.ccr.cancer.gov/seminar-series/seminar/}{Distinguished Speakers Seminar Series}. 2020 Apr 9. (Postponed to due COVID-19).
\item 
{\it \href{https://docs.google.com/presentation/d/1ZSkeK_bnYdVbiqN8gt4gouFeXY91DyKSjI922y3GZFY/edit?usp=sharing}{More (single-cell) data, more (statistical) problems}}. \\ 
...
\item \href{https://academicdatascience.org/adsa-meetings/annual-meeting}{Academic Data Science Alliance (ADSA) Annual Meeting}. 2020 Oct 14-16. (Virtual due to COVID-19). 
\item {\it Analyzing Genomics Data in R with Bioconductor}. \href{https://www.meetup.com/rladies-riverside/}{R-Ladies Riverside}. 2020 Jul 22. (Virtual). 
\item Academic Data Science Alliance (ADSA) Data Science Education Special Interest Group (SIG). Presented a talk on \href{https://docs.google.com/presentation/d/10lRcBMdZ_lzWWCW46t1rThJ1kVm7Ip0Yx3UIdicUEAg/edit?usp=sharing} {Addressing Real-World Challenges through Data Science Education}. 2020 Jul 2. Virtual.
\item {\it Mathematical Frameworks for Integrative Analysis of Emerging Biological Data Types} (\href{http://www.birs.ca/events/2020/5-day-workshops/20w5197}{website}) (attendee and session chair). 2020 Jun 14-19. Banff International Research Station. (Virtual due to COVID-19). 
\item US Bureau of Labor Statistics. 2020 Mar 2. Washington, DC. USA.
\item 
