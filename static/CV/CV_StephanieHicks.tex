...
\item Joint Initiative on Generalizable Data Science Methods for Biomedical Research between the Division of Mathematical Sciences (DMS) at the NSF and the National Library of Medicine (NLM) at the NIH (2019)
...
\subsection*{\texttt{OpenCaseStudies} Data Analyses}
...
\mine % Nov 18
Korthauer K, Kimes PK, Duvallet C, Reyes A, Subramanian A, Teng M, Shukla C, Alm EJ, {\bf Hicks SC}. (2018).  A Practical Guide to Methods Controlling False Discoveries in Computational Biology. \dg{{\it bioRxiv}. doi: \url{https://doi.org/10.1101/458786}}.
\mine % Nov 17
...
\dn{Dates:} 03/01/2018 -- 02/28/2019.
...
\item 
{\it Addressing Open Challenges in Genomics and Data Science Education}. \\ 
Department of Statistics, Smith College. 2019 Apr 18. Northampton, MA. USA.
\item 
